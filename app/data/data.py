...
valid_claude_models = {
  "claude-sonnet-4-6": "Claude Sonnet 4.6 (Next-gen Sonnet tier: high throughput, production workloads with strong coding & reasoning) ",
  ...
  "claude-opus-4-6": "Claude Opus 4.6 (Top-tier flagship: complex reasoning, long context, full-agent capability and highest accuracy) ",
